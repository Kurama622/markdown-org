...
if selectLang == 'go':
    ...
    resultText = subprocess.getstatusoutput("{} {} -o {} && ./{} && rm {}".format(language_path[selectLang], cfile, filename, filename, filename))[-1]
    ...
    for idx in selectIndex:
        ...
        filename = vim.eval("expand('%<')")
    resultText = subprocess.getstatusoutput("{} {} -o {} && ./{} && rm {}".format(language_path[selectLang], cppfile, filename, filename, filename))[-1]
