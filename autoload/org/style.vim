...
"----------------------------------------------------------------------
let g:org#style#border = get(g:, 'org#style#border', 2)
...
let g:org#style#bordercolor = get(g:, 'org#style#bordercolor', 'String')
let g:org#style#color = get(g:, 'org#style#color', 'String')
